...
public class Github extends Command<EmptySession> {
    ...
    public void execute(TBot bot, TUpdate update, List<String> history) {
        bot.sendMessage(update.getChatId(), """
                ...
                =| Добавлена поддержка обработки файлов <b>.xls</b>, <b>.docx</b>, <b>.txt</b>
                =| Обновлен интерфейс (чуть-чуть подкрутил)
                =| Пофикшены баги, производительность улучшена, бла-бла-бла
